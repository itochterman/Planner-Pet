...
public class CoinSprite:SKSpriteNode {
    ...
    public static func sharedInstance() -> CoinSprite {
        ...
        coinNode.physicsBody?.categoryBitMask = PhysicsFlyCategory.Coin
        coinNode.physicsBody?.contactTestBitMask = PhysicsFlyCategory.Player
        coinNode.physicsBody?.collisionBitMask = PhysicsFlyCategory.None
