...
class PenguinEntity:GKEntity {
    ...
    func addPhysics(){
        ...
        spriteNode.physicsBody?.categoryBitMask  = PhysicsFlyCategory.Player
        spriteNode.physicsBody?.contactTestBitMask = PhysicsFlyCategory.Coin | PhysicsFlyCategory.Obstacle | PhysicsFlyCategory.Floor
    }
